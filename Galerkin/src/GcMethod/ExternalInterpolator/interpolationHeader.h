...
const ValueType * R,
const ValueType * V);
//Считаю целесообразным использовать высоту и число Куранта как для 2_4. 
//V содержит 10 значений, как для N=2.
//R из 15 точек x, y, z, xA, yA, zA, xB, yB, zB, xC, ...
